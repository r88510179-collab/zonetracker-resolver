-- Canonical schema for zonetracker-resolver.
-- The runtime schema is applied incrementally from src/db/migrations/*.sql
-- by src/db/migrate.js. This file is kept as a convenient reference of the
-- current shape; to change the database, add a new migration file.
